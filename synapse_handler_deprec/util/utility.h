...
/// guards
#ifndef __UG__PLUGINS__CABLE_NEURON__SYNAPSE_HANDLING__UTIL__UTILITY_H__
#define __UG__PLUGINS__CABLE_NEURON__SYNAPSE_HANDLING__UTIL__UTILITY_H__
...
#endif ///!<  __UG__PLUGINS__CABLE_NEURON__SYNAPSE_HANDLING__UTIL__UTILITY_H__
