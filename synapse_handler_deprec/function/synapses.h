...
/// guard
#ifndef __UG__PLUGINS__CABLE_NEURON__SYNAPSE_HANDLING__FUNCTION__SYNAPSES_H__
#define __UG__PLUGINS__CABLE_NEURON__SYNAPSE_HANDLING__FUNCTION__SYNAPSES_H__
...
#endif // __UG__PLUGINS__CABLE_NEURON__SYNAPSE_HANDLING__FUNCTION__SYNAPSES_H__
