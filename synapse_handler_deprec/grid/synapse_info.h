...
/// guard
#ifndef __UG__PLUGINS__CABLE_NEURON__SYNAPSE_HANDLING__GRID__SYNAPSE_INFO_H__
#define __UG__PLUGINS__CABLE_NEURON__SYNAPSE_HANDLING__GRID__SYNAPSE_INFO_H__
...
#endif // __UG__PLUGINS__CABLE_NEURON__SYNAPSE_HANDLING__GRID__SYNAPSE_INFO_H__
