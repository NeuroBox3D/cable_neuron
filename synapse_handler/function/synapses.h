...
/// guard
#ifndef __H__UG__SYNAPSE_HANDLER__FUNCTION__SYNAPSES__
#define __H__UG__SYNAPSE_HANDLER__FUNCTION__SYNAPSES__
...
#endif // __H__UG__SYNAPSE_HANDLER__FUNCTION__SYNAPSES__
