...
/// guard
#ifndef __H__UG__SYNAPSE_HANDLER__SYNAPSE_SELECTOR__
#define __H__UG__SYNAPSE_HANDLER__SYNAPSE_SELECTOR__
...
#endif // __H__UG__SYNAPSE_HANDLER__SYNAPSE_SELECTOR__
