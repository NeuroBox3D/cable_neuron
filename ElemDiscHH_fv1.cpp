...
add_jac_A_elem(LocalMatrix& J, const LocalVector& u, GridObject* elem, const MathVector<dim> vCornerCoords[])
{
	...
	// 	get current SCVF
		...
		// 	Add to local matrix
			...
			// Ableigung nach h,m,n ohne Ableitung wird matrix singul�r
...
//	Diffusion and Velocity Term
	...
	//	}
	//	std::cout << "add Jac A läuft" << std::endl;
	//}
	...
	number valuen = 0;
		...
		for(size_t ip = 0; ip < geo.num_scv(); ++ip)
			...
			//	remember local solutions
				...
				// capazität erstmal nicht benutzen in diesem fall nur im ersten wert
