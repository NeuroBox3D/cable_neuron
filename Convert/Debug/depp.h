...
const static         gnabar = .12 ; 
const static         gkbar = .036 ; 
const static         gl = .0003 ; 
const static         el = -54.3 ; 
...
ADouble naGate; 
Grid::AttachmentAccessor<Vertex, ADouble> aanaGate; 
ADouble kGate; 
Grid::AttachmentAccessor<Vertex, ADouble> aakGate; 
ADouble mGate; 
