...
template<typename TDomain> 
std::vector<number> NMDA_Mg_T_converted_standard_UG<TDomain>::allGatingAccesors(number x, number y, number z) 
{ 
	 //var for output 
...
template<typename TDomain> 
void NMDA_Mg_T_converted_standard_UG<TDomain>::ionic_current(Vertex* ver, const std::vector<number>& vrt_values, std::vector<number>& outCurrentValues) 
{ 
