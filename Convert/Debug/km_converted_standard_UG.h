#ifndef km_converted_standard_UG_H_
#define km_converted_standard_UG_H_
...
template <typename TDomain> 
class km_converted_standard_UG
...
km_converted_standard_UG(const char* functions, const char* subsets) 
...
m_R(8.314), m_T(293.0), m_F(96485.0), 
	...
	vmin ( -120	*1), 
	vmax ( 100	*1) {} 
UG_CATCH_THROW("Error in km_converted_standard_UG initializer list. ") 
 
 
/// @copydoc IChannel<TDomain>::IChannel(const std::vector<std::string>&) 
km_converted_standard_UG(const std::vector<std::string>& functions, const std::vector<std::string>& subsets) 
try : IChannel<TDomain>(functions, subsets), 
m_R(8.314), m_T(293.0), m_F(96485.0), 
	gbar ( 10   	*1e+06), 
	tha  ( -30	*1), 
...
virtual ~km_converted_standard_UG() {}; 
...
#endif // km_converted_standard_UG_H_
