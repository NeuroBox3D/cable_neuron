...
#ifndef UG__PLUGINS__CABLE_NEURON__MEMBRANE_TRANSPORT__ION_LEAKAGE_H
#define UG__PLUGINS__CABLE_NEURON__MEMBRANE_TRANSPORT__ION_LEAKAGE_H
...
#endif // UG__PLUGINS__CABLE_NEURON__MEMBRANE_TRANSPORT__ION_LEAKAGE_H
