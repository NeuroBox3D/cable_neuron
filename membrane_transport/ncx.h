...
#ifndef UG__PLUGINS__CABLE_NEURON__MEMBRANE_TRANSPORT__NCX_H
#define UG__PLUGINS__CABLE_NEURON__MEMBRANE_TRANSPORT__NCX_H
...
#endif  // UG__PLUGINS__CABLE_NEURON__MEMBRANE_TRANSPORT__NCX_H
