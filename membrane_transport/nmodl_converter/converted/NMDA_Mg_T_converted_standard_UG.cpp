...
void NMDA_Mg_T_converted_standard_UG<TDomain>::ce_obj_available()  
{  
	init_attachments();  
 	F = m_pCE->F; 
 R = m_pCE->R; 
...
if (spGrid->has_vertex_attachment(this->FGate)) 
UG_THROW("Attachment necessary (FGate) for NMDA_Mg_T_converted_standard_UG channel dynamics "
"could not be made, since it already exists."); 
spGrid->attach_to_vertices(this->FGate); 
this->aaFGate = Grid::AttachmentAccessor<Vertex, ADouble>(*spGrid, this->FGate); 
 
if (spGrid->has_vertex_attachment(this->ClGate)) 
UG_THROW("Attachment necessary (ClGate) for NMDA_Mg_T_converted_standard_UG channel dynamics "
"could not be made, since it already exists."); 
...
UG_THROW("Attachment necessary (D1Gate) for NMDA_Mg_T_converted_standard_UG channel dynamics "
"could not be made, since it already exists."); 
...
UG_THROW("Attachment necessary (D2Gate) for NMDA_Mg_T_converted_standard_UG channel dynamics "
"could not be made, since it already exists."); 
...
UG_THROW("Attachment necessary (OGate) for NMDA_Mg_T_converted_standard_UG channel dynamics "
"could not be made, since it already exists."); 
...
UG_THROW("Attachment necessary (UMgGate) for NMDA_Mg_T_converted_standard_UG channel dynamics "
"could not be made, since it already exists."); 
...
UG_THROW("Attachment necessary (ClMgGate) for NMDA_Mg_T_converted_standard_UG channel dynamics "
"could not be made, since it already exists."); 
...
UG_THROW("Attachment necessary (D1MgGate) for NMDA_Mg_T_converted_standard_UG channel dynamics "
"could not be made, since it already exists."); 
...
UG_THROW("Attachment necessary (D2MgGate) for NMDA_Mg_T_converted_standard_UG channel dynamics "
"could not be made, since it already exists."); 
...
UG_THROW("Attachment necessary (OMgGate) for NMDA_Mg_T_converted_standard_UG channel dynamics "
"could not be made, since it already exists."); 
...
template<typename TDomain> 
std::vector<number> NMDA_Mg_T_converted_standard_UG<TDomain>::state_values(number x, number y, number z) 
{ 
	 //var for output 
	 ...
	 { 
	 	 ...
	 	 if (m_log_FGate == true) 
	 	 	 GatingAccesors.push_back(this->aaFGate[bestVrt]); 
...
template<typename TDomain> void NMDA_Mg_T_converted_standard_UG<TDomain>::set_log_D1Gate(bool bLogD1Gate) { m_log_D1Gate = bLogD1Gate; }
template<typename TDomain> void NMDA_Mg_T_converted_standard_UG<TDomain>::set_log_D2Gate(bool bLogD2Gate) { m_log_D2Gate = bLogD2Gate; }
template<typename TDomain> void NMDA_Mg_T_converted_standard_UG<TDomain>::set_log_OGate(bool bLogOGate) { m_log_OGate = bLogOGate; }
template<typename TDomain> void NMDA_Mg_T_converted_standard_UG<TDomain>::set_log_UMgGate(bool bLogUMgGate) { m_log_UMgGate = bLogUMgGate; }
template<typename TDomain> void NMDA_Mg_T_converted_standard_UG<TDomain>::set_log_ClMgGate(bool bLogClMgGate) { m_log_ClMgGate = bLogClMgGate; }
template<typename TDomain> void NMDA_Mg_T_converted_standard_UG<TDomain>::set_log_D1MgGate(bool bLogD1MgGate) { m_log_D1MgGate = bLogD1MgGate; }
template<typename TDomain> void NMDA_Mg_T_converted_standard_UG<TDomain>::set_log_D2MgGate(bool bLogD2MgGate) { m_log_D2MgGate = bLogD2MgGate; }
template<typename TDomain> void NMDA_Mg_T_converted_standard_UG<TDomain>::set_log_OMgGate(bool bLogOMgGate) { m_log_OMgGate = bLogOMgGate; }
 // Init Method for using gatings 
template<typename TDomain> 
void NMDA_Mg_T_converted_standard_UG<TDomain>::init(Vertex* vrt, const std::vector<number>& vrt_values) 
{ 
...
template<typename TDomain> 
void NMDA_Mg_T_converted_standard_UG<TDomain>::update_gating(number newTime, Vertex* vrt, const std::vector<number>& vrt_values) 
{ 
// inits temperatur from kalvin to celsius and some other typical neuron values
number m_T, m_R, m_F; 
m_T = m_pCE->temperature(); 
...
template<typename TDomain> 
void NMDA_Mg_T_converted_standard_UG<TDomain>::current(Vertex* ver, const std::vector<number>& vrt_values, std::vector<number>& outCurrentValues) 
{ 
...
//////////////////////////////////////////////////////////////////////////////// 
#ifdef UG_DIM_1 
template class NMDA_Mg_T_converted_standard_UG<Domain1d>; 
#endif 
 
 
#ifdef UG_DIM_2 
template class NMDA_Mg_T_converted_standard_UG<Domain2d>; 
#endif 
 
 
#ifdef UG_DIM_3 
template class NMDA_Mg_T_converted_standard_UG<Domain3d>; 
#endif 
