#ifndef kadist_g01_converted_standard_UG_H_
#define kadist_g01_converted_standard_UG_H_
...
template <typename TDomain> 
class kadist_g01_converted_standard_UG
...
kadist_g01_converted_standard_UG(const char* functions, const char* subsets) 
...
m_log_nGate(false), 
m_log_lGate(false) {} 
UG_CATCH_THROW("Error in kadist_g01_converted_standard_UG initializer list. "); 
 
 
/// @copydoc ICableMembraneTransport<TDomain>::ICableMembraneTransport(const std::vector<std::string>&) 
kadist_g01_converted_standard_UG(const std::vector<std::string>& functions, const std::vector<std::string>& subsets) 
try : ICableMembraneTransport<TDomain>(functions, subsets), 
        ek ( -90 *1), 
	gkabar(.008 *1e-05), 
        vhalfn(-1   *1), 
...
virtual ~kadist_g01_converted_standard_UG() {}; 
...
#endif // kadist_g01_converted_standard_UG_H_
