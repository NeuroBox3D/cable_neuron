...
#ifndef UG__PLUGINS__CABLE_NEURON__UTIL__DIAM_ATTACHMENT_HANDLER_H
#define UG__PLUGINS__CABLE_NEURON__UTIL__DIAM_ATTACHMENT_HANDLER_H
...
#endif // UG__PLUGINS__CABLE_NEURON__UTIL__DIAM_ATTACHMENT_HANDLER_H
