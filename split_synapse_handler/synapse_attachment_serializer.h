...
#ifndef __UG__PLUGINS__CABLE_NEURON__SPLIT_SYNAPSE_HANDLER__SYNAPSE_ATTACHMENT_SERIALIZER_H__
#define __UG__PLUGINS__CABLE_NEURON__SPLIT_SYNAPSE_HANDLER__SYNAPSE_ATTACHMENT_SERIALIZER_H__
...
/**
 * As the split synapse attachment is a vector only containing pointers
...
#endif // __UG__PLUGINS__CABLE_NEURON__SPLIT_SYNAPSE_HANDLER__SYNAPSE_ATTACHMENT_SERIALIZER_H__
